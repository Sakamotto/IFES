...
public class TadMatrixHash {
	...
	public boolean ehIgual(TadMatrixHash mat){
	...
	public TadMatrixHash multiplica(TadMatrixHash mat2){
		TadMatrixHash result = new TadMatrixHash(this.getMatLinhas(), mat2.getMatColunas());
		double soma;
